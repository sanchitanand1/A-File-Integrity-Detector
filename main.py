...
baselines = r"C:\Users\Sanchit\Desktop\baselines"  # Baseline.txt will be at this specified path
secure_path = ""
...
root = ctk.CTk()
root.title("   A FILE INTEGRITY DETECTOR")
root.geometry("650x700")  # (x,y)
# root.geometry("")
# root.resizable(False,True)
root.wm_iconphoto(False, tk.PhotoImage(file=r"C:\Users\Sanchit\Desktop\Hashline\window_icon.png"))
...
browse_btn = ctk.CTkButton(master=root,
                           text="SEARCH",
                           image=tk.PhotoImage(file=r"C:\Users\Sanchit\Desktop\Hashline\browse.png").subsample(10, 10),
                           compound=ctk.RIGHT,
                           command=open_file,
                           fg_color=btn_fg_clr,
...
update_baseline_btn = ctk.CTkButton(master=root,
                                    ...
                                    image=tk.PhotoImage(file=r"C:\Users\Sanchit\Desktop\Hashline\updatebaseline.png").subsample(18, 18),
                                    compound=ctk.RIGHT,
...
check_integrity_btn = ctk.CTkButton(master=root,
                                    ...
                                    image=tk.PhotoImage(file=r"C:\Users\Sanchit\Desktop\Hashline\checkintegrity.png").subsample(9, 9),
                                    compound=ctk.RIGHT,
